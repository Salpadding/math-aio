...
\begin{proof}
    ...
    Therefore $W$ is linearly independent and is an upper bound for the chain $C$. 
    By Zorn's Lemma, $\mathcal{E}$ has a maximal element $B$. 
    
    We claim that $B$ spans $V$. If not, there exists $v \in V$ such that $v \notin \text{span}(B)$. 
    Then $B \cup \{v\}$ would be linearly independent, contradicting the maximality of $B$. 
