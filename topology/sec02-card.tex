...
\begin{proof}
    Given a family of nonempty sets $\{A_{\alpha}: \alpha \in I \}$. Since $A_{\alpha}$ could be well-ordering by 
...
\begin{proof}
    For sake of contradiction, assume $A$ not contains any maximal. 
    ...
    To construct such injection, we will start with $\alpha_0 \in \mathrm{Ord}$ by pick any $a_0 \in A$.
