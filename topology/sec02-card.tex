...
\begin{proof}
    ...
    If exists $y \in J \setminus I_b$, there exists $x \in A$ and $b \le y < x$, which shows $b \in I_x$, which is 
...
\begin{exercise}
    ...
    \[
        A = \{x \in \mathbb{R}: \lim_{n \to \infty} f(x) = \infty \}
    \]
...
\begin{proof}
    ...
    Since $f$ has limitation of $\infty$ at $x'$, we got $f(x_n) \to \infty$ here, which is   
    contradict with $f(x_n) \le N$.
